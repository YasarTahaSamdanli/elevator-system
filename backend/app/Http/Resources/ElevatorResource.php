...
class ElevatorResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'last_inspection_at' => $this->last_inspection_at?->toDateString(),
            'next_inspection_due' => $this->next_inspection_due?->toDateString(),
            'follow_up_due' => $this->follow_up_due?->toDateString(),
            'notes' => $this->notes,
